...
var RUN_MOTOR_FOR_POWER_AND_TIME_FUNCTION = "void runMotor(bool isLeft, bool isForward, int powerPerPercent, int time){
if(isForward && isLeft){
...
var RUN_MOTOR_FOR_DISTANCE_AND_POWER_FUNCTION = "void runMotor(bool isLeft, bool isForward, int powerPerPercent, int distance){}";
